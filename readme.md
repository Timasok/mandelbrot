...
```
Ключевое слово ```volatile``` возле переменной придаёт ей статус неоптимизируемой. Таким образом все вычисления, в которых она участвует, становятся неоптимизируемыми. 
